...
As três galerias de projetos e a galeria acadêmica usam arquivos de teste identificados, conforme autorizado durante a implementação. O Portfólio Cósmico não exibe galeria, pois o visitante já navega pelo próprio projeto. Nenhuma dessas imagens é apresentada como captura real ou comprovação acadêmica. A foto de perfil, textos, experiências e cursos continuam vindo do portfólio existente.
