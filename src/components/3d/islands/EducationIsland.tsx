...
export const EducationIsland: React.FC = () => {
  ...
  return (
    <group>
      {/* =========================================================
          TERRA FIRME & GRAMA ESTILIZADA TOY MINIATURE
         ========================================================= */}

      {/* Layer 1: Terracotta Terraces Base */}
      ...
      {/* Under-cliff Toy Rock Shards with Bevel Look */}
      {[
        [-2.5, -3.2, 1.5, 0.9],
        [2.8, -3.0, -1.2, 1.1],
        [0.4, -3.8, 2.6, 0.8],
        ...
        <mesh key={i} position={[x, y, z]} scale={[s, s * 1.3, s]} castShadow>
          ...
          <meshStandardMaterial color="#5c341d" roughness={0.88} metalness={0.05} flatShading />
        </mesh>
      ))}
      ...
      <mesh position={[0, -0.6, 0]} receiveShadow>
        ...
        <meshStandardMaterial color="#9a5b32" roughness={0.85} metalness={0.05} flatShading />
      </mesh>

      {/* Layer 2: Lush Pastel Green Grass Cap (Beveled rim) */}
      ...
      {/* Gentle Low-Poly Grass Mounds for depth */}
      <mesh position={[-1.6, 0.15, -1.2]} receiveShadow>
        <sphereGeometry args={[2.2, 8, 6, 0, Math.PI * 2, 0, Math.PI / 2]} />
        <meshStandardMaterial color="#10b981" roughness={0.85} metalness={0.05} flatShading />
      </mesh>
      <mesh position={[2.0, 0.12, 1.0]} receiveShadow>
        <sphereGeometry args={[1.8, 8, 6, 0, Math.PI * 2, 0, Math.PI / 2]} />
        <meshStandardMaterial color="#4ade80" roughness={0.85} metalness={0.05} flatShading />
      </mesh>
      ...
      {[
        ...
        >
          ...
          <meshStandardMaterial color="#cbd5e1" roughness={0.85} metalness={0.05} flatShading />
        </mesh>
      ))}
      ...
      <group position={[-2.4, 1.8, 1.0]} rotation={[-0.45, 0.35, 0.65]}>
        ...
        <mesh castShadow>
          ...
          <meshStandardMaterial color="#facc15" roughness={0.85} metalness={0.05} />
        </mesh>

        {/* Metal Ferrule Collar */}
        <mesh position={[0, -2.3, 0]}>
          <cylinderGeometry args={[0.43, 0.43, 0.5, 12]} />
          <meshStandardMaterial color="#94a3b8" roughness={0.85} metalness={0.08} />
        </mesh>

        {/* Pink Rubber Eraser */}
        <mesh position={[0, -2.75, 0]}>
          <cylinderGeometry args={[0.41, 0.41, 0.5, 12]} />
          <meshStandardMaterial color="#f472b6" roughness={0.88} metalness={0.02} />
        </mesh>
      ...
      {/* =========================================================
          CADERNO ESPIRAL ABERTO TOY MINIATURE
         ========================================================= */}
        ...
        <group position={[-1.1, 0, 0]} rotation={[0, 0.08, 0]}>
          ...
          {[-0.8, -0.4, 0, 0.4, 0.8].map((lz, idx) => (
            <mesh key={idx} position={[0, 0.12, lz]}>
              ...
              <meshStandardMaterial color="#93c5fd" roughness={0.85} metalness={0.02} />
            </mesh>
          ))}
          <mesh position={[0, 0.125, 0]}>
            <planeGeometry args={[1.2, 0.12]} />
            <meshStandardMaterial color="#fde047" roughness={0.85} metalness={0.02} transparent opacity={0.65} />
          </mesh>
        </group>
      ...
      {/* =========================================================
          PILHA DE LIVROS COLORIDOS TOY STYLE
         ========================================================= */}
      ...
      {/* =========================================================
          CAPELO ACADÊMICO TOY MINIATURE
         ========================================================= */}
      ...
      {/* =========================================================
          PINHEIROS LOW-POLY & COGUMELOS
         ========================================================= */}
      <group position={[-2.8, 0.1, -1.8]}>
        <mesh position={[0, 0.6, 0]} castShadow>
          <cylinderGeometry args={[0.18, 0.25, 1.2, 6]} />
          <meshStandardMaterial color="#78350f" roughness={0.88} metalness={0.02} />
        </mesh>
        <mesh position={[0, 1.4, 0]} castShadow>
          <coneGeometry args={[1.1, 1.2, 6]} />
          <meshStandardMaterial color="#15803d" roughness={0.85} metalness={0.05} flatShading />
        </mesh>
        <mesh position={[0, 2.1, 0]} castShadow>
          <coneGeometry args={[0.85, 1.1, 6]} />
          <meshStandardMaterial color="#16a34a" roughness={0.85} metalness={0.05} flatShading />
        </mesh>
        <mesh position={[0, 2.7, 0]} castShadow>
          <coneGeometry args={[0.55, 0.9, 6]} />
          <meshStandardMaterial color="#22c55e" roughness={0.85} metalness={0.05} flatShading />
        </mesh>
      </group>
      ...
      <pointLight position={[0, 3.0, 0]} color="#4ade80" intensity={1.8} distance={10} />
    </group>
  );
};
